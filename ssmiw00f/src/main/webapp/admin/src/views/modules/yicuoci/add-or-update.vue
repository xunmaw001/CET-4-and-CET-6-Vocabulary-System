<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="易错单词" prop="yicuodanci">
          <el-input v-model="ruleForm.yicuodanci" 
              placeholder="易错单词" clearable  :readonly="ro.yicuodanci"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="易错单词" prop="yicuodanci">
              <el-input v-model="ruleForm.yicuodanci" 
                placeholder="易错单词" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发音" prop="fayin">
          <el-input v-model="ruleForm.fayin" 
              placeholder="发音" clearable  :readonly="ro.fayin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发音" prop="fayin">
              <el-input v-model="ruleForm.fayin" 
                placeholder="发音" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
...
export default {
            ...
            ruleForm: {
                	        yicuodanci: '',
	                        	        ...
	                        	        faburiqi: '',
                                                                                                ...
                                                                                                rules: {
                  yicuodanci: [
                            { required: true, message: '易错单词不能为空', trigger: 'blur' },
                                    	                                                              ],
                  zimu: [
                                    	                                                              ],
                  tupian: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yicuoci/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yicuociCrossAddOrUpdateFlag = false;
                  this.parent.search();
