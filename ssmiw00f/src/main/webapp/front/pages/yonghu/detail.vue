	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback" :bottom="100">
		<view class="container">
				...
				<swiper-item v-for="(swiper,index) in swiperList" :key="index">
					...
					<view class="text" :style='{"color":"rgba(255, 144, 0, 1)","textAlign":"left","fontSize":"28rpx"}'>{{detail.xingming}}</view>
				</view>
                				                				<view class="detail-list-item" :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","margin":"2rpx 2rpx 2rpx 2rpx 2rpx","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"solid solid solid solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"#333","textAlign":"left"}'>性别：</view>
					<view class="text" :style='{"color":"rgba(255, 144, 0, 1)","textAlign":"left","fontSize":"28rpx"}'>{{detail.xingbie}}</view>
				</view>
                				                								                				<view class="detail-list-item" :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","margin":"2rpx 2rpx 2rpx 2rpx 2rpx","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"solid solid solid solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"#333","textAlign":"left"}'>身份证：</view>
					<view class="text" :style='{"color":"rgba(255, 144, 0, 1)","textAlign":"left","fontSize":"28rpx"}'>{{detail.shenfenzheng}}</view>
				</view>
                				                				<view class="detail-list-item" :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","margin":"2rpx 2rpx 2rpx 2rpx 2rpx","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"solid solid solid solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"auto","fontSize":"28rpx","color":"#333","textAlign":"left"}'>手机：</view>
					<view class="text" :style='{"color":"rgba(255, 144, 0, 1)","textAlign":"left","fontSize":"28rpx"}'>{{detail.shouji}}</view>
				</view>
